                ...
                <div className="flex gap-4 w-full flex-wrap justify-center px-8 max-md:px-2 pt-16 pb-12 text-black border-b-2 border-gray-400">
                    <div className="flex justify-around w-5/12 max-lg:w-180 max-md:w-96">
                        <div className="w-1/2">
                            ...
                            <div className="ml-2">
                                ...
                                <a className="flex items-center hover:underline text-gray-700" href="https://www.patreon.com/GMCRolePlay310?utm_medium=clipboard_copy&utm_source=copyLink&utm_campaign=creatorshare_fan&utm_content=join_link" target="_blank" rel="noopener noreferrer">
                                    <svg className="w-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080">
                                        <path className="fill-gray-700" d="M1033.05,324.45c-0.19-137.9-107.59-250.92-233.6-291.7c-156.48-50.64-362.86-43.3-512.28,27.2C106.07,145.41,49.18,332.61,47.06,519.31c-1.74,153.5,13.58,557.79,241.62,560.67c169.44,2.15,194.67-216.18,273.07-321.33c55.78-74.81,127.6-95.94,216.01-117.82C929.71,603.22,1033.27,483.3,1033.05,324.45z" />
                                    </svg>
                                    Patreon
                                </a>
                            </div>
                    ...
                    <div className="flex justify-around w-5/12 max-lg:w-180 max-md:w-96">
                        ...
                        <div className="w-1/2">
                            ...
                            <div className="ml-2 flex-col flex">
                                <a href="/newitem/" className="text-gray-700 hover:underline">新商品申請</a>
                                <a href="/newitemlist/" className="text-gray-700 hover:underline">申請リスト</a>
                            </div>
                        </div>
                    </div>
                </div>
